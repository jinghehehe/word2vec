...
if __name__ == '__main__':
    ...
    default=os.path.join(cache_dir, 'wiki.zh.txt'), help='input:traditional file')
    parser.add_option('-o', '--output', dest='output_file',
    default=os.path.join(cache_dir, 'wiki.zh.chs.txt'), help='output:simplified file')
