...
if __name__ == '__main__':
    ...
    default=os.path.join(cache_dir, '2019110663.txt'), help='output:test file with similaraties')
    parser.add_option('-m', '--inmodel', dest='path_Word2Vec_Model',
    default=os.path.join(model_dir, 'wiki.word2vec.model'), help='input: path to word2vec model')
    parser.add_option('-v', '--invec', dest='path_Word2Vec_Vec',
    default=os.path.join(model_dir, 'wiki.word2vec.vectors'), help='input: path to word2vec vec')
